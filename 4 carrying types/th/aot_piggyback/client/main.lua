...
function OpenActionMenuInteraction(target)
	...
	for i=1, #hostageAllowedWeapons do
		...
		anim2 = 'victim_idle'
		distans = 0.11 --สูงกว่า = ใกล้กับกล้องมากขึ้น
		distans2 = -0.24 --สูงกว่า = ซ้าย
		height = 0.0
		spin = 0.0		
		length = 100000
		controlFlagMe = 49
...
Citizen.CreateThread(function()
	while true do 
		if holdingHostage then
			if GetEntityHealth(GetPlayerPed(-1)) <= 102 then --คุณอาจต้องแก้ไขการตรวจสอบการตายนี้สำหรับเซิร์ฟเวอร์ของคุณ
			...
			DisableControlAction(0,24,true) -- ปิดการใช้งานการโจมตี
			DisableControlAction(0,25,true) -- ปิดการใช้ aim
			DisableControlAction(0,47,true) -- ปิดการใช้งานอาวุธ
			DisableControlAction(0,58,true) -- ปิดการใช้งานอาวุธ
			DisablePlayerFiring(GetPlayerPed(-1),true)
			local playerCoords = GetEntityCoords(GetPlayerPed(-1))
			DrawText3D(playerCoords.x,playerCoords.y,playerCoords.z,"กด [G] ที่จะปล่อย, [H] ที่จะฆ่า")
			if IsDisabledControlJustPressed(0,47) then --ปล่อย
				print("release this mofo")			
				holdingHostage = false
				holdingHostageInProgress = false 
				--ClearPedSecondaryTask(GetPlayerPed(-1))
				...
				Wait(100)
				releaseHostage()
			elseif IsDisabledControlJustPressed(0,74) then --ฆ่า 
		...
		if beingHeldHostage then 
			DisableControlAction(0,21,true) -- ปิดการใช้งานการวิ่ง
			DisableControlAction(0,24,true) -- ปิดการใช้งานการโจมตี
			DisableControlAction(0,25,true) -- ปิดการใช้ aim
			DisableControlAction(0,47,true) -- ปิดการใช้งานอาวุธ
			DisableControlAction(0,58,true) -- ปิดการใช้งานอาวุธ
			DisableControlAction(0,263,true) -- ปิดใช้งานระยะอาวุธหรือการต่อยประชิด
			DisableControlAction(0,264,true) -- ปิดใช้งานระยะอาวุธหรือการต่อยประชิด
			DisableControlAction(0,257,true) -- ปิดใช้งานระยะอาวุธหรือการต่อยประชิด
			DisableControlAction(0,140,true) -- ปิดใช้งานระยะอาวุธหรือการต่อยประชิด
			DisableControlAction(0,141,true) -- ปิดใช้งานระยะอาวุธหรือการต่อยประชิด
			DisableControlAction(0,142,true) -- ปิดใช้งานระยะอาวุธหรือการต่อยประชิด
			DisableControlAction(0,143,true) -- ปิดใช้งานระยะอาวุธหรือการต่อยประชิด
			DisableControlAction(0,75,true) -- ปิดการใช้งานการออกจากยานพาหนะ
			DisableControlAction(27,75,true) -- ปิดการใช้งานการออกจากยานพาหนะ  
			DisableControlAction(0,22,true) -- ปิดการใช้งานการกระโดด
			DisableControlAction(0,32,true) -- ปิดการใช้งานเลื่อนขึ้น
			DisableControlAction(0,268,true)
			DisableControlAction(0,33,true) -- ปิดการใช้งานเลื่อนลง
			DisableControlAction(0,269,true)
			DisableControlAction(0,34,true) -- ปิดการใช้งานเลื่อนไปทางซ้าย
			DisableControlAction(0,270,true)
			DisableControlAction(0,35,true) -- ปิดการใช้งานเลื่อนไปทางขวา
